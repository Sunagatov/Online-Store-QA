...
class TestForgotPassword:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("john doe@gmail.com", "Email must be valid"),
            pytest.param("user!name@gmail.com", "Email must be valid"),
            pytest.param("@gmail.com", "Email must be valid"),
            pytest.param("username@gmail", "Email must be valid"),
            pytest.param("user@name@gmail.com", "Email must be valid"),
            pytest.param(".username@gmail.com", "Email must be valid"),
